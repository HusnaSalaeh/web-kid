                  ...
                  <div class="row gx-3 gy-2 align-items-center">
                    ...
                    <div class="bs-toast toast fade show bg-success" role="alert" aria-live="assertive" aria-atomic="true">
                        <div class="toast-header">
                          ...
                          <div class="me-auto fw-semibold">สีเขียว</div>
                          <a href=""><small>*กดเพื่อดูคำแนะนำการฝึกซ้ำ</small></a>
                          <!-- <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button> -->
                        </div>
                        <div class="toast-body">
                         เก่งแล้วน่ะ! ไม่ผ่าน 1 ด้าน(ไม่มีโรคประจำตัว) <br>
                          <small>ลองดูอีกครั้ง! อีกนิดเดียวเท่านั้นนะ <br>
                          แนะนำให้กลับมาประเมินซ้ำภายใน 30 วัน
                        </small>
                        </div>
                      </div>
                    </div>
                    <div class="mt-4">
                    <a href="1.php" id="showToastPlacement" class="btn btn-primary me-2">ดูประวัติการประเมิน</a>
                    <a href="1.php" id="showToastPlacement" class="btn btn-outline-secondary">ประเมินซ้ำ</a>
                        </div>
                  </div>
                </div>
              </div>
