...
?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Assessment /</span> ช่วงอายุแรกเกิด 1 เดือน</h4>
                  ...
                  <div class="card mb-4">
                       ...
                       <div class="col-md-6 mb-2" >
                          ...
                          <div class="form-check form-check-inline ">
                            <input
                              ...
                              value="option1"
                            />
                            <label class="form-check-label" for="inlineRadio1">ผ่าน (เด็กทำได้ติ๊กลงในช่องนี้)</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input
                              class="form-check-input"
                              ...
                              value="option2"
                            />
                            <label class="form-check-label" for="inlineRadio2">ไม่ผ่าน (เด็กทำไม่ได้ติ๊กลงในช่องนี้)</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                        <div class="col-md-9">
                          <h5 class="fw-semibold d-block">1.ท่านอนคว่ำยกศรีษะและหันไปข้างใดข้างหนึ่งได้</h5>
                          <div class="form-check form-check-inline ">
                            <input
                              class="form-check-input"
                              type="radio"
                        ...
                        <div class="col-md-9">
                          <h5 class="fw-semibold d-block">3.สะดุ้งหรือเคลื่อนไหวร่างกายเมื่อได้ยินเสียงพูดระดับปกติ</h5>
                          <div class="form-check form-check-inline ">
                            <input
                              class="form-check-input"
                              type="radio"
