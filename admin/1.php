    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <div class="form-check form-check-inline ">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                id="inlineRadio1" value="option1" onclick="this.checked = false;" />
                                            <label class=" form-check-label" for="inlineRadio1">ผ่าน
                                                (เด็กทำได้ติ๊กลงในช่องนี้)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                id="inlineRadio2" value="option2" onclick="this.checked = false;" />
                            ...
                            <hr class="my-0" />
                            <div class="card-body">
                                <form action="assessment-result.php" id="formAccountSettings" method="POST">
                                    <div class="row">
                                        <div class="col-md-9">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label" for="pass4">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineRadioOptions4" id="pass4" value="option2" />
                                                    ไม่ผ่าน</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label" for="fail5">
                                                    <input class="form-check-input" type="radio"
                                                        name="inlineRadioOptions5" id="fail5" value="option1" />
                                                    ไม่ผ่าน</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="hidden" name="passCount" id="passCount" value="0">
                                        <button onclick="checkResults()" type="submit"
                                            class="btn btn-primary me-2">บันทึกข้อมูล</button>
            ...
            function checkResults() {
                const passCount = document.querySelectorAll('input[type="radio"][value="option1"]:checked').length;
