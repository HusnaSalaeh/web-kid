                ...
                <div class="card-body">
                    <div class="row gx-3 gy-2 align-items-center">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="1.php" id="showToastPlacement"
                                class="btn btn-primary d-block">ดูประวัติการประเมิน</a>
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex align-items-end row">
                            ...
                            <div class="col-sm-8 text-center">
                                <div class="card-body">
                                    <img src="../assets/img/backgrounds/result.png" width="100%" alt="background" />
                                </div>
                            </div>
                        </div>
                    </div>
