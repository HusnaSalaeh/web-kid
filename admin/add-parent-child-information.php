...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">ฟอร์ม/</span> เพิ่มข้อมูลผู้ปกครองและลูก
            </h4>
            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form role="form" action="add-parent-child-information-db.php" method="post" name="form1"
                                onsubmit="return checkForm();" class="form-horizontal" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="lastName" id="basic-icon-default-company"
                                            class="form-control" placeholder="กรุณากรอกนามสกุล" aria-label="ACME Inc."
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" name="age" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="กรุณากรอกอายุ"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-phone2" class="input-group-text"><i
                                                class='bx bx-first-aid'></i></span>
                                        <input type="text" name="disease" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="กรุณากรอกโรคประจำตัว"
                                            aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" name="childNo" id="basic-icon-default-phone"
                                            class="form-control phone-mask" placeholder="กรุณากรอกจำนวนเด็กในความดูแล"
                                            aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" />
                                    </div>
                                </div>
                                <!-- <div class="mb-3">
                            ...
                            />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" list="datalistOptions" id="exampleDataList"
                                        name="relation" placeholder="พิมพ์เพื่อค้นหา..." />
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-icon-default-phone">โทรศัพท์ที่ติดต่อได้</label>
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-phone2" class="input-group-text"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-company2" class="input-group-text"><i
                                            class="bx bx-body"></i></span>
                                    <input type="number" name="weight" id="basic-icon-default-company"
                                        class="form-control" placeholder="กรุณากรอกน้ำหนักปัจจุบัน" />
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-company2" class="input-group-text"><i
                                            class="bx bx-body"></i></span>
                                    <input type="number" name="height" id="basic-icon-default-company"
                                        class="form-control" placeholder="กรุณากรอกส่วนสูง" aria-label="ACME Inc."
                                        aria-describedby="basic-icon-default-company2" />
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" name="birthWeight" id="basic-icon-default-company"
                                        class="form-control" placeholder="กรุณากรอกน้ำหนักแรกคลอด"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check mt-3">
                                    <input class="form-check-input" type="radio" name="birthHistory" id="onDueDate"
                                        value="ครบกำหนด" checked />
                                    <label class="form-check-label" for="defaultRadio2"> ครบกำหนด </label>
                                </div>
                                <div class="form-check ">
                                    <input class="form-check-input" type="radio" name="birthHistory" id="beforeDueDate"
                                        value="ก่อนกำหนด" />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea id="basic-icon-default-message" name="address" class="form-control"
